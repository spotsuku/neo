  ...
  try {
    ...
    const mockSettings: SystemSetting[] = [
      ...
      },
      {
        ...
        category: 'security',
        key: 'cors_origins',
        value: '["https://neo-platform.pages.dev", "http://localhost:3000"]',
        type: 'json',
      ...
      },
      {
        ...
        category: 'email',
        key: 'smtp_user',
        value: 'noreply@neo-platform.com',
        type: 'string',
      ...
      },
      {
        ...
        category: 'email',
        key: 'from_email',
        value: 'NEO Digital Platform <noreply@neo-platform.com>',
        type: 'string',
        description: 'メール送信者',
        isEditable: true,
        updatedBy: 'admin',
